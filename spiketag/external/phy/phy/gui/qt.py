...
# -----------------------------------------------------------------------------
try:
    import PyQt5 # Test for Qt5
    from PyQt5.QtCore import (Qt, QByteArray, QMetaObject, QObject,  # noqa
                              QVariant, QEventLoop, QTimer, QPoint, QTimer,
                              pyqtSignal, pyqtSlot, QSize, QUrl, pyqtRemoveInputHook)
    try:
        from PyQt5.QtCore import QPyNullVariant  # noqa
    except:  # pragma: no cover
        QPyNullVariant = None
    try:
        from PyQt5.QtCore import QString  # noqa
    except:  # pragma: no cover
        QString = None
